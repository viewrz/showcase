...
import { Flex, Text, Box, Logo, Button, Fading } from './base-components';
      ...
      >
        <Box flex="auto" flexBasis="0" p={2}>
          ...
          <Box>
            ...
            <Box>
              <Bullet />Creative input
            </Box>
            <Box>
              <Bullet />Best practice sharing
            </Box>
          </Box>
        </Box>
        <Box flex="auto" flexBasis="0" p={2}>
          ...
          <Box>
            <Box>
              <Bullet />From brief to reporting
            </Box>
            <Flex>
              <Bullet />Centralised influencer pool management
            </Flex>
          </Box>
        </Box>
        <Box flex="auto" flexBasis="0" p={2}>
          ...
          <Flex>
            <Bullet />Documentation & screenshots
          </Flex>
        </Box>
      </Flex>
